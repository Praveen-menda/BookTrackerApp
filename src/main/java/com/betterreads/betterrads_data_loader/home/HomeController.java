package com.betterreads.betterrads_data_loader.home;


import java.util.List;
import java.util.stream.Collectors;

import com.betterreads.betterrads_data_loader.user.BooksByUser;
import com.betterreads.betterrads_data_loader.user.BooksByUserRepository;
...
public class HomeController {
    ...
    public String home(@AuthenticationPrincipal OAuth2User principal, Model model) {
        ...
        booksByUser = booksByUser.stream().distinct().map(book -> {
            String coverImageUrl = "src/main/resources/images/noImage.png";
